...
REM
REM Generated by Vivado on Fri Sep 06 01:34:55 +0530 2024
...
echo "xvlog --incr --relax -prj tb_intrcntrl_vlog.prj"
call xvlog  --incr --relax -prj tb_intrcntrl_vlog.prj -log xvlog.log
