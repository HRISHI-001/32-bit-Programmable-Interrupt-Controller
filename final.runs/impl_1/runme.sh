...
HD_PWD='C:/vivadoxilinx/final/final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log intrcntrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source intrcntrl.tcl -notrace
