...
HD_PWD='C:/vivadoxilinx/final/final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log intrcntrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source intrcntrl.tcl
